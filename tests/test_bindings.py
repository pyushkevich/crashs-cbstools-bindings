"""Smoke tests for the GraalVM-native cbstools bindings in crashs_cbstools_bindings.
...
(built by native/scripts/build_native.sh) and to be importable as
crashs_cbstools_bindings, i.e. either an installed wheel or the artifact staged
under src/crashs_cbstools_bindings/_native_lib/ and _native_data/ for local dev.
"""
import numpy as np
import pytest
