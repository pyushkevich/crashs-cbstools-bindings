"""crashs_cbstools_bindings: direct Python bindings to a GraalVM Native Image build of
the cbstools-public algorithms that crashs needs (topology correction, CRUISE cortical
extraction, levelset-to-mesh, surface inflation, volumetric layering) - replacing the
nighres/JCC/JVM dependency crashs previously used to reach this code.
